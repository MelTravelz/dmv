...
RSpec.describe DmvDataService do
  ...
  describe '#wa_ev_registrations' do
    it 'can load washington ev registration data' do
      ...
      expect(@dds.wa_ev_registrations).to be_an(Array)
      expect(@dds.wa_ev_registrations[0]).to be_a(Hash)
      expect(@dds.wa_ev_registrations[0].keys.size).to eq(34)
    end
  end
  ...
  describe '#co_dmv_office_locations' do
    it 'can load colorado dmv office locations' do
      ...
      expect(@dds.co_dmv_office_locations).to be_an(Array)
      expect(@dds.co_dmv_office_locations[0]).to be_a(Hash)
      expect(@dds.co_dmv_office_locations[0].keys.size).to eq(15)
    end
  end
  ...
  describe '#ny_dmv_office_locations' do
    it 'can load new york dmv office locations' do
      ...
      expect(@dds.ny_dmv_office_locations).to be_an(Array)
      expect(@dds.ny_dmv_office_locations[0]).to be_a(Hash)
      expect(@dds.ny_dmv_office_locations[0].keys.size).to eq(21)
    end
  end
  ...
  describe '#mo_dmv_office_locations' do
    it 'can load missouri dmv office locations' do
      ...
      expect(@dds.mo_dmv_office_locations).to be_an(Array)
      expect(@dds.mo_dmv_office_locations[0]).to be_a(Hash)
      expect(@dds.mo_dmv_office_locations[0].keys.size).to eq(25)
    end
  end
end
